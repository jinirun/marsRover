...
function move(rover){
  ...
  switch(rover.direction){
    case 'N': newX = rover.xCoordinate;
      ...
      break;
    case 'E': newX = rover.xCoordinate+1 > rover.plateauCoordinates[0] ? rover.xCoordinate : rover.xCoordinate+1;
      newY = rover.yCoordinate;
      break;
    case 'S': newX = rover.xCoordinate;
      newY = rover.yCoordinate-1 < 0 ? rover.yCoordinate : rover.yCoordinate-1;
      break;
    case 'W': newX = rover.xCoordinate-1 < 0 ? rover.xCoordinate : rover.xCoordinate-1;
      newY = rover.yCoordinate;
      break;
  }
  return [newX, newY];
